...
- 판매 상품 삭제
  ...
  | Actor Action                                                             | System Response                                                                                                    |
  | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
  | 1. 판매 중인 목록에서 삭제하고자 하는 상품의 삭제 버튼을 클릭한다.       | 2. 삭제를 할 것인지 한 번 더 확인하는 알림창을 띄운다.                                                             |
  | 3. 삭제하고자 한다면 "예" 버튼을 누르고 아니라면 "아니오" 버튼을 누른다. | 4. "예" 버튼 입력이 되었다면 삭제 완료 메세지를 출력하고 "아니오" 버튼이 입력되었다면 삭제 취소 메세지를 출력한다. |
